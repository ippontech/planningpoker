...
export interface IVoteDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="planningpokerApp.vote.delete.question" interpolate={{ id: voteEntity.id }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(VoteDeleteDialog);
